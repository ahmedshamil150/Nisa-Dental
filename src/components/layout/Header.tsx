    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 px-margin-mobile py-2 flex items-center gap-2 pointer-events-none">
        ...
        <div className="pointer-events-auto relative shrink-0">
          <div className={`bg-primary/90 backdrop-blur-md border border-primary-border/40 rounded-2xl shadow-sm flex flex-col items-center transition-all duration-300 ease-out overflow-hidden ${iconsOpen ? "px-4 py-3 gap-3" : "px-2 py-2 gap-1.5"}`}>
            <Link href="/cart" className="flex items-center justify-center gap-3 text-on-primary hover:opacity-80 transition-opacity w-full">
            ...
            <Link href="/appointment" className="flex items-center justify-center gap-3 text-on-primary hover:opacity-80 transition-opacity w-full">
            ...
            <Link href="/track" className="flex items-center justify-center gap-3 text-on-primary hover:opacity-80 transition-opacity w-full">
            ...
            <button onClick={() => setIconsOpen(!iconsOpen)}
              ...
              <span className="material-symbols-outlined text-[18px] transition-transform duration-300 ease-out" style={{ transform: iconsOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}>expand_more</span>
            </button>
          </div>
        </div>
      </header>
