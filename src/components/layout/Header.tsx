    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 px-margin-mobile py-2 flex items-center gap-2 pointer-events-none">
        ...
        <div className="pointer-events-auto relative shrink-0">
          <div className={`bg-primary/90 backdrop-blur-md border border-primary-border/40 shadow-sm flex flex-col items-stretch transition-all duration-300 ease-out ${iconsOpen ? "rounded-2xl px-4 py-3 gap-3" : "rounded-full px-3 py-2.5 gap-2.5"}`}>
